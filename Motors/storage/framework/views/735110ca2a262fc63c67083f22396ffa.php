...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/templatemo-hexashop.css')); ?>">
...
-->
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href=" <?php echo e(route('loja.menu')); ?> " class="logo">
                                <img src=" <?php echo e(asset( 'images/logo.png' )); ?>"  alt="">
                            </a>
                            <!-- ***** Logo End ***** -->
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <li class="scroll-to-section"><a href=" <?php echo e(route('loja.menu')); ?> " class="active">Home</a></li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <?php $__currentLoopData = $carrosPorMarca; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca => $carros): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href=" <?php echo e(route('loja.marca', ['marca' => $marca ])); ?> "><?php echo e($marca); ?></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </li>
                                <li class="scroll-to-section"><a href=" <?php echo e(route('login')); ?> ">🚺Login</a></li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="first-item">
                            <div class="logo">
                                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="hexashop ecommerce templatemo">
                            </div>
                            <ul>
        ...
        <script src="<?php echo e(asset('js/imgfix.min.js')); ?>"></script> 
...
</html><?php /**PATH C:\Users\si\Downloads\Motors-main\Motors-main\Motors\resources\views/template/index.blade.php ENDPATH**/ ?>